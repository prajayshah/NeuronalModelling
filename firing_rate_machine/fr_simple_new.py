...
funcs.make_general_scatter([x_range], [result], alpha=1, s=60, figsize=(3,3), ax_titles=['Random Plot'], legend_labels=['a'])
        ...
        for j, y in enumerate(y_range):
            ...
            if save:
                to_save = {'avg_fr': result,
                           ...
                           'title': f"input vs h strength",
                           'experiment': 'input vs h strength, g=1',
